...
class WSDAMCache {
  private:
    ...
    vector<WSDAMDirectorySet> directory;
    vector<WSDAMDirectorySet> sorted_directory;
  ...
  public:
    ...
    bool sort_helper(WSDAMDirectorySet i, WSDAMDirectorySet j);
    ...
    */
    WSDAMCache(int base_assoc, int block_size, int cache_size, int address_width, bool write_policy, int passiveness);
